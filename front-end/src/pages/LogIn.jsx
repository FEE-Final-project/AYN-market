...
export default function LogIn() {
  ...
  async function handleResetPassword() {
    ...
    if (res.data.resetPassword.success) {
      ...
      toast.error("Something went wrong check the email you entered")
    }
  }
  ...
  mb-28">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className='text-pink-500 font-bold text-xl'>
            Forget your password ? <button className="text-indigo-500 hover:text-indigo-300" onClick={handleResetPassword}>
              click here
            </button>
          </div>
        </div>
